...
public class MapperMaxHeightTest {
    @Mock
    private Mapper.Context context;
    private MapperMaxHeight mapperMaxHeight;

    @Before
    public void setup() {
        this.mapperMaxHeight = new MapperMaxHeight();
    }
    ...
    public void testMap() throws IOException, InterruptedException {
        ...
        this.mapperMaxHeight.map(null, new Text(value), this.context);
